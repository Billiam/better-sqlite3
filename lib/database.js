...
function Database(filenameGiven, options) {
    ...
    const bindings = 'bindings' in options ? options.bindings : null
	...
	if (nativeBindingPath !== null) {
		...
		const bindingOptions = {
			bindings: path.basename(bindings),
			module_root: path.dirname(bindings),
			try: [[ 'module_root', 'bindings' ]]
		}
		addon = require('bindings')(bindingOptions);
	} else {
